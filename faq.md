...
doesn't mean that in the future we will not support the Atmel or Maxim or Freescale MCU products.
    ...
    For more details view the [supported hardware](hardware.html) list.
...
1. What are the operating systems that VIC&trade; supports ?
    ...
    The VIC&trade; compiler works on Linux, Mac OS X, FreeBSD, OpenBSD and Microsoft Windows.

1. What are the compilers and auxilliary tools that VIC&trade; works with ?
